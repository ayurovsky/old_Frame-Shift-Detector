...
for line in samFile:
	...
	if (int(ts[1]) & 0x0004):
		continue
	# check that mapping quality is >= 40 - means that we are only counting uniquely mapped reads 
	if (int(ts[4]) < 40):
		continue
	...
	# for all-jan and young, do only 28
	if (read_len == 28): # no need to shift reads, majority class is in frame 1
		pass
	else:
		continue
#	# for  wu and guydosh- only do 28 or 29
# if (read_len == 28): # no need to shift reads, majority class is in frame 1
#		pass
#	elif (read_len == 29):  # majority class is in frame 3, shift forward by 1
...
#		pass
#	elif (read_len == 26 or read_len == 29):  # majority class is in frame 3, shift forward by 1
#		if (Orfs_Seq_Dict[gene]["strand"] == "-"):
#			read_end -= 1
#			read_len -= 1
#		else:
#			read_start += 1
#			read_len -= 1
#	elif (read_len == 27 or read_len == 32):  # majority class is in frame 2, shift back by 1
#		if (Orfs_Seq_Dict[gene]["strand"] == "-"): 
#			read_end += 1
#			read_len += 1
#		else:
...
#	if (read_len == 28): # no need to shift reads, majority class is in frame 1
#		pass
#	elif (read_len == 31 or read_len == 32):  # majority class is in frame 3, shift forward by 1
#		if (Orfs_Seq_Dict[gene]["strand"] == "-"):
#			read_end -= 1
#			read_len -= 1
#		else:
...
# for gerashchenko 
#	if (read_len == 28 or read_len == 25 or read_len == 23): # no need to shift reads, majority class is in frame 1
#		pass
#	elif (read_len == 29):  # majority class is in frame 3, shift forward by 1
#		if (Orfs_Seq_Dict[gene]["strand"] == "-"):
#			read_end -= 1
...
#			read_start += 1
#			read_len -= 1
#	elif (read_len == 27 or read_len == 32 or read_len == 33):  # majority class is in frame 2, shift back by 1
#		if (Orfs_Seq_Dict[gene]["strand"] == "-"): 
#			read_end += 1
#			read_len += 1
#		else:
...
#			read_start += 1
#			read_len -= 1
#	elif (read_len == 32 or read_len == 33):  # majority class is in frame 2, shift back by 1
#		if (Orfs_Seq_Dict[gene]["strand"] == "-"): 
#			read_end += 1
#			read_len += 1
#		else:
